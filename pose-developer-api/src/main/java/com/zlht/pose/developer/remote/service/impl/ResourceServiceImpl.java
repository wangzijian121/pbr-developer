...
import com.zlht.pose.developer.dao.mapper.ResourceMapper;
import com.zlht.pose.developer.remote.enums.Status;
import com.zlht.pose.developer.remote.service.ResourceServiceI;
...
public class ResourceServiceImpl extends BaseServiceImpl implements ResourceServiceI {
    ...
    @Override
    public Map<String, Object> deleteResource(int  userId, String uuid) {
