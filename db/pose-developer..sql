...
VALUES (1, '足球射门姿势算法', 0, 1, 1, 1, 1, 'ea', '文档', '这是一个案例', '2023-08-14 17:47:57'),
       (3, '游泳姿势优化算法', 1, 8, 1, 1, 1, 'ea', '文档', '这是一个案例', '2023-08-14 17:45:11'),
       (5, '网球发球技术分析算法', 0, 12, 1, 1, 1, 'ea',
        '分析网球发球的动作和力量，评估发球技术的准确性和速度，提供改进建议。', '这是一个案例', '2023-08-14 17:47:47'),
       (10, '田径起跑姿势优化算法', 1, 1, 2, 2, 1, 'e1a1f62d-85a4-4a96-8af5-0440d41e0abd', '文档', '样例',
        '2023-08-14 17:47:20'),
       (14, '足球专用犯规识别算法', 0, 7, 1, 0, 1, NULL, '文档', '文档demo', '2023-08-14 02:27:31'),
       (15, '篮球手部识别算法', 1, 7, 1, 0, 1, 'a66bd977-82c5-4d3b-9a97-f3aa7c5f24a7', '文档', '样例demo',
        '2023-08-14 02:32:31'),
       (16, '乒乓球角度识别编辑', 1, 11, 4, 0, 1, 'a45af1c1-a66a-4a80-b3e7-2ae6c743907f', '文档', 'demo',
        '2023-08-14 17:53:22');
...
VALUES (1, '足球数据集', 1, 1, '4b4901b8-7af4-444a-b044-3067902cfaf2', 'demo', 1, 1, '2023-08-08 23:57:51');
...
INSERT INTO `session`
VALUES ('ddc95d0e-8e07-4849-81a7-452c90a5e607', 12, '172.27.224.1', '2023-08-18 17:30:29');
