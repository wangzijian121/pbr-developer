 ...
 */
@Service
public class SportServiceImpl extends BaseServiceImpl implements SportServicesI {
    ...
    @Override
    public Result querySportMap(int userId, MultiValueMap<String, String> values) {
        ...
        String suffix = UriComponentsBuilder.fromPath("developer/getSportMap")
                .build()
                .toUriString();
        ...
        try {
            ...
            logger.error("getSport() method .message={}", errMsg, e);
